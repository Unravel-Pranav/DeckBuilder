...
2. Specify slot_assignments whose element_types match that template's slots
3. Reference real column names from the data profile in data_columns
  ...
  "slot_assignments": [
    {
      ...
      "chart_type": "bar_chart" | "line_chart" | "pie_chart" | "stacked_bar_chart" | null,
