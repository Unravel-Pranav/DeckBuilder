        ...
        sections: [
          {
            ...
            suggestedTemplates: [
              { id: crypto.randomUUID(), name: 'Key Metrics Dashboard', type: 'chart-heavy', structure: 'two-col', previewDescription: 'Bar chart with KPI highlights and commentary' },
              { id: crypto.randomUUID(), name: 'Summary Table', type: 'table-heavy', structure: 'two-col', previewDescription: 'Condensed data table with key takeaways' },
            ],
            accepted: true,
          },
          {
            ...
            suggestedTemplates: [
              { id: crypto.randomUUID(), name: 'Market Trend Lines', type: 'chart-heavy', structure: 'blank', previewDescription: 'Multi-line chart showing market trends over time' },
              { id: crypto.randomUUID(), name: 'Competitive Matrix', type: 'table-heavy', structure: 'two-col', previewDescription: 'Comparison table of key competitors' },
              { id: crypto.randomUUID(), name: 'Market Insights', type: 'commentary', structure: 'blank', previewDescription: 'AI-generated market analysis narrative' },
            ],
            accepted: true,
          },
          {
            ...
            suggestedTemplates: [
              { id: crypto.randomUUID(), name: 'Revenue Breakdown', type: 'chart-heavy', structure: 'two-col', previewDescription: 'Stacked bar chart with revenue by segment' },
              { id: crypto.randomUUID(), name: 'P&L Summary', type: 'table-heavy', structure: 'blank', previewDescription: 'Detailed profit & loss statement table' },
            ],
            accepted: true,
          },
          {
            ...
            suggestedTemplates: [
              { id: crypto.randomUUID(), name: 'Insight Cards', type: 'mixed', structure: 'grid-2x2', previewDescription: 'Visual cards with icons and insight summaries' },
              { id: crypto.randomUUID(), name: 'Action Items', type: 'commentary', structure: 'blank', previewDescription: 'Prioritized list of recommended actions' },
            ],
            accepted: true,
          },
        ],
