...
class UnitCheckAgent(BaseAgent):
    ...
    AGENT_CONFIG_KEY = "unit_check_agent"
    ...
    def __init__(self, state: Dict[str, Any]) -> None:
        ...
        self.agent_prompts = load_agent_prompts("unit_check_agent")
    ...
    def _initialize_agent_specific_attributes(self) -> None:
        ...
        self.agent_type = "unit_check"  # Set agent type for YAML goal loading
    ...
    def _create_agent(self):
        """Create ReAct agent with dynamic prompting for unit checking validation."""
    ...
    def _dynamic_prompt(
        ...
        """Dynamic prompt that combines system and user prompts for unit checking validation."""
        ...
        try:
            ...
            try:
                ...
                if settings.AGENTS_DEBUG:
                    logger.info("🎯 UNIT CHECK AGENT - EXACT PROMPTS BEING SENT TO LLM")
            ...
            MultiAgentWorkflowException.log_exception(e, "unit_check_validation")
            raise MultiAgentWorkflowException(
                "Error in unit_check validation node ", sys.exc_info()
            )
