...
def _can_scale_to_fit_in_grid(
    ...
    """
    from hello.utils.ppt_helpers_utils.services.template_config import get_layout_threshold_config
...
def _calculate_element_height_for_layout(
    ...
    if element_type == "table":
        ...
        from hello.utils.ppt_helpers_utils.ppt_helpers.content_height_calculator import calculate_total_element_height
